...
Feature: ComputerPage Feature
  As a User, I should be able to add product in a cart and navigate to desktops page successfully
  ...
  @sanity @smoke
  Scenario: Verify that User should navigate to computer page successfully
